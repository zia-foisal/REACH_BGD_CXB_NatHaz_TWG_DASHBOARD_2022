...
- The model output provides information about expected flooded area, water depth and speed of water flow forthe various scenarios. It is primarily designed as a macro-level site planning tool. The product can be used to quickly identify areas which may be at higher risk. All insights gained from the product must be investigated in the field.
